...
export default function Model(props) {
  const group = useRef()
  const { nodes, materials } = useGLTF('/world2test.glb')
  return (
    <group ref={group} {...props} dispose={null}>
      ...
      <mesh
        ...
        scale={[0.33, 0.33, 0.33]}
        onClick={()=>console.log('tree 001!')}
      />
      <mesh geometry={nodes.World.geometry} material={materials['Material.001']} scale={[0.33, 0.33, 0.33]} 
...
useGLTF.preload('/world2test.glb')
